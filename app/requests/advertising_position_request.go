...
type AdvertisingPositionRequest struct {
	...
	// FIXME()
	AdvertisingPositionName string `valid:"advertising_position_name" json:"advertising_position_name,omitempty"`
...
func AdvertisingPositionSave(data interface{}, c *gin.Context) map[string][]string {
	...
	rules := govalidator.MapData{
		// "name":        []string{"required", "min_cn:2", "max_cn:8", "not_exists:advertising_positions,name"},
